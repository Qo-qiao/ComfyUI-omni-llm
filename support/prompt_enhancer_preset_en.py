...
ZIMAGE_TURBO_EN = {
    ...
    "description": "Designed for Z-Image-Turbo model, 8-step inference for 1080P portrait generation. Automatically identifies clothing style (ancient Chinese/Japanese school/workwear/sports/wedding/street fashion/Lolita/swimwear/lingerie/general), outputs detailed descriptions for corresponding dimensions.",
    "input_template": "Optimize portrait Prompt and generate {mode} description. User input: #\n\nStep 1: Determine the clothing style category from the image/text (choose one from: Ancient Chinese/Hanfu, Japanese/School, Office/Professional, Sports/Fitness, Wedding/Formal, Street/Hip-hop, Lolita, Swimwear/Lingerie, General).\nStep 2: Output corresponding field group based on category.\nMust include: camera parameters, subject appearance, pose expression, environment scene, composition rules, lighting type, color scheme.\nCategory-specific fields see format description below.",
    "output_format_suffix": {
