...
NORMAL_DESCRIBE_TAGS_EN = {
    ...
    "description": "Image Tag Reverse Generator, analyzes provided image content and generates comma-separated tag lists, extracting visual elements and converting them into concise tag formats for guiding AI to generate images of the same style",
    ...
    "output_format_suffix": {
        "natural": "\n\n**【Format Requirements】** Output pure text comma-separated tag list directly, **total tags strictly controlled between 30-60, no duplicates**. For example: tag1, tag2, tag3, ...\nDo not add any explanation or additional content.",
    ...
    "examples": [
        {
            "natural": "Japanese fresh portrait, cherry blossom tree, 23-year-old Asian female, almond eyes, delicate cream skin, black wavy hair, natural makeup, matte lip gloss, white lace dress, pearl earrings, soft side lighting, afternoon natural light, 35mm prime lens, f/1.8 aperture, shallow depth of field, golden ratio composition, film texture, delicate skin texture, lace texture, pink petals, bokeh background",
            "structured": "【Subject Features】23-year-old Asian female, almond eyes, delicate cream skin, black wavy hair, natural makeup\n【Clothing & Styling】white lace dress, pearl earrings, matte lip gloss\n【Environment & Scene】cherry blossom tree, spring outdoor, pink petals falling, bokeh background with blurred green grass\n【Color Palette】pink, white, light pink, soft tones\n【Lighting Effects】soft side lighting, afternoon natural light, hair rim light\n【Composition Style】medium portrait, 35mm prime lens, f/1.8 aperture, shallow depth of field\n【Art Style】Japanese fresh portrait, realistic photography, film texture\n【Texture & Details】delicate skin texture, lace texture, petal details"
        }
    ]
}
...
NORMAL_DESCRIBE_EN = {
    ...
    "description": "Image Reverse Description Expert, analyzes provided image content, extracts detailed visual information and generates structured descriptions for guiding AI to generate images of the same style",
    "input_template_natural": "Analyze the provided image content and generate detailed English image description prompts. If custom content is provided, use it as the basis: #. Analyze and describe in detail: subject features (if any), scene environment, composition style, lighting effects, color palette, details texture, etc., organizing all visual elements into a coherent English paragraph.",
    "input_template_structured": "Analyze the provided image content and generate detailed English image description prompts. If custom content is provided, use it as the basis: #. Analyze and describe in detail: subject features (if any), scene environment, composition style, lighting effects, color palette, details texture, etc., with the goal of using the reverse prompt to let AI generate images of the same style.",
    "output_format_suffix": {
        "natural": "\n\n**【Format Requirements】** Output natural paragraph text directly, describing subject features (if any), action pose (if any), environment scene, composition style, style features, lighting effects, color palette, details texture, technical parameters and clothing styling in detail, organizing all visual elements into a coherent English paragraph. Do not output any explanation or other content.",
        "structured": "\n\n**【Format Requirements】** Output using the following fields (select necessary fields based on image content): 【Subject Description】【Action Pose】【Environment Scene】【Composition Style】【Style Features】【Lighting Effects】【Color Palette】【Details Texture】【Technical Parameters】【Clothing Styling】. Each field on one line, highly detailed, emphasizing micro-textures and optical effects. Do not add any explanation."
    },
    "task_requirements": [
        "Accurately analyze image content, extract all key visual elements",
        "Subject describes appearance and posture; action describes movement and expression; environment describes scene; composition describes framing and lens; style describes overall style; lighting describes light; color describes colors; details describe textures; parameters describe quality and camera; clothes describe attire",
    ...
    "examples": [
        {
            "natural": "A 23-year-old Asian woman stands under a cherry blossom tree in spring. She has soft facial lines, almond eyes with distinct lashes, and delicate cream skin texture. Black hair falls in natural waves with subtle shine. She wears light makeup with matte lip gloss. She stands naturally, gazing gently at the camera with a slight smile, body slightly turned to the right. Pink petals drift around her, creating a dreamy bokeh background with blurred green grass visible in the distance. The medium portrait uses a 35mm prime lens at f/1.8, creating beautiful shallow depth of field with golden ratio composition. The style is Japanese fresh photography, realistic style, film texture. Soft afternoon side lighting creates gentle shadow transitions with subtle hair rim light. Colors are primarily pink and white with pearl white and light pink accents, low saturation, overall soft tone. Details include the lace dress with clear pattern, distinct hair strands with shine, natural skin texture, and delicate petals. Technical quality is high definition, soft focus bokeh, 4K quality, natural film color grading. She wears a white lace dress with pearl earrings and ruffled hemline.",
            "structured": "【Subject Description】23-year-old Asian female, soft facial lines, almond eyes with distinct lashes, delicate cream skin texture visible, black long wavy hair with natural shine, light makeup, matte lip gloss\n【Action Pose】Standing naturally, gazing gently at camera with slight smile, body slightly turned to the right\n【Environment Scene】Under cherry blossom tree, spring outdoor, pink petals drifting, bokeh background with blurred green grass visible in distance\n【Composition Style】Medium portrait, 35mm prime lens, f/1.8 aperture, shallow depth of field, golden ratio composition\n【Style Features】Japanese fresh photography, realistic style, film texture\n【Lighting Effects】Soft side lighting, afternoon natural light, gentle shadow transitions, subtle hair rim light\n【Color Palette】Pink and white dominated, pearl white and light pink accents, low saturation, overall soft tone\n【Details Texture】Lace dress with clear pattern visible, distinct hair strands with shine, natural skin texture, delicate petals\n【Technical Parameters】High definition, soft focus bokeh, 4K quality, natural film color grading\n【Clothing Styling】White lace dress with pearl earrings, ruffled hemline"
        }
    ]
}
...
PROMPT_EXPANDER_EN = {
    ...
    "input_template_natural": "Expand the user-provided prompt into detailed, vivid, and contextually rich text, enhancing its clarity and expressiveness for AI generation tasks (text-to-image/video/story, etc.), strictly preserving the original intent and core keywords. If custom content is provided, use it as the basis: #\n\n**Natural paragraph output requirements:** Describe subject features (if any), scene environment, action details (if any), emotional tone, and additional details in detail, organizing all elements into a coherent English paragraph.",
    "input_template_structured": "Expand the user-provided prompt into detailed, vivid, and contextually rich text, enhancing its clarity and expressiveness for AI generation tasks (text-to-image/video/story, etc.), strictly preserving the original intent and core keywords. If custom content is provided, use it as the basis: #\n\n**Structured output requirements:** One field per line, including 【Subject Description】【Scene Environment】【Action Details】【Emotional Tone】【Additional Details】【Complete Prompt】.",
    "output_format_suffix": {
        "natural": "\n\n**【Format Requirements】** Output natural paragraph text directly, describing subject features (if any), scene environment, action details (if any), emotional tone, and additional details in detail, organizing all elements into a coherent English paragraph. Do not output any explanation or other content.",
        "structured": "\n\n**【Format Requirements】** Include the following fields: 【Subject Description】【Scene Environment】【Action Details】【Emotional Tone】【Additional Details】【Complete Prompt】. Each field on one line, highly detailed, emphasizing micro-textures and environmental atmosphere. Do not add any explanation."
    },
    "steps": [
    ...
    "task_requirements": [
        ...
        "Expanded content should be vivid, detailed, and contextually rich",
        "Content should be coherent and logically clear",
        "Structured format requires more detail, natural paragraph format requires coherence and naturalness"
    ],
    "examples": [
        {
            "natural": "By a sunlit café window, a 25-year-old Asian woman sits quietly. She has black long straight hair falling softly over her shoulders, gentle almond eyes that are warm and bright, and fair skin with a delicate complexion. She wears a light beige knit sweater with exquisite lace trim at the cuffs. She is intently reading a hardcover book with yellowed pages, occasionally looking up at the window with a thoughtful expression in her eyes, her fingers gently turning the pages. Before her sits a steaming latte with intricate patterns on the cup and delicate latte art. The surrounding environment is quiet and cozy, other customers conversing softly in the background, and gentle jazz music playing softly. Sheer curtains are half-drawn, the street outside is faintly visible, the café interior is elegantly decorated, and the wooden table surface shows clear grain texture. The entire scene is peaceful, warm, and focused.",
            "structured": "【Subject Description】A 25-year-old Asian woman, black long straight hair falling softly over shoulders, gentle almond eyes warm and bright, fair skin with delicate complexion, wearing light beige knit sweater with exquisite lace trim at cuffs\n【Scene Environment】By a sunlit café window, wooden table with visible grain texture clearly visible, sheer curtains half-drawn, street outside faintly visible, café interior elegantly decorated and cozy\n【Action Details】Sitting by the window, intently reading a hardcover book with yellowed pages, occasionally looking up at the window with thoughtful expression in eyes, fingers gently turning pages\n【Emotional Tone】Peaceful, warm, focused\n【Additional Details】Before her sits a steaming latte with intricate cup patterns and delicate latte art, surrounding environment quiet, other customers conversing softly, gentle jazz music playing softly in background\n【Complete Prompt】A 25-year-old Asian woman sits by a sunlit café window, wearing a light beige knit sweater with exquisite lace trim at the cuffs. She has black long straight hair falling softly over her shoulders, gentle almond eyes that are warm and bright, and fair skin with a delicate complexion. She is intently reading a hardcover book with yellowed pages, occasionally looking up at the window with a thoughtful expression in her eyes, and then returning to her reading, her fingers gently turning the pages. Before her sits a steaming latte with intricate patterns on the cup and delicate latte art. The surrounding environment is quiet and cozy, other customers conversing softly in the background, and gentle jazz music playing softly. Sheer curtains are half-drawn, the street outside is faintly visible, the café interior is elegantly decorated, and the wooden table surface shows clear grain texture."
        }
    ]
}
...
ILLUSTRIOUS_EN = {
    ...
    "output_format_suffix": {
        "natural": "\n\n**【Format Requirements】** Output natural paragraph text directly, describing character appearance features, action pose, scene environment, composition style, style features, lighting effects, color palette, details texture, quality parameters and clothing styling in detail, organizing all elements into a coherent English paragraph. Do not output any explanation or other content.",
        "structured": "\n\n**【Format Requirements】** Include the following fields: 【Character Appearance】【Action Pose】【Environment Scene】【Composition Style】【Style Features】【Lighting Effects】【Color Palette】【Details Texture】【Quality Parameters】【Clothing Styling】. Each field on one line, highly detailed, emphasizing anime style features. Do not add any explanation."
    },
    "constraints": {
        "max_length": 300,
    ...
    "examples": [
        {
            "natural": "A 16-year-old anime girl with blue-purple gradient twintails that curl slightly at the ends. She has golden star-shaped pupils that sparkle, a delicate oval face, and snow-white skin with a faint pink blush. She wears a sweet smile. Her pose is cute with body slightly turned right, head tilted left, and hands clasped near her chest. The background is a pink-to-white gradient with floating cherry blossom petals creating a dreamy atmosphere. Composition is a half-body shot from slightly above with soft diagonal framing. Style is masterpiece quality with cel shading and clean line art. Soft light from upper left creates gentle rim lighting around her hair with catchlights in her eyes. Color palette features white, red, and gold with soft pastels. Details include sailor uniform with gold trim, red bow tie, and pleated skirt.",
            "structured": "【Character Appearance】16-year-old anime girl, blue-purple gradient twintails with slightly curled ends, golden star-shaped pupils with sparkle, delicate oval face, snow-white skin with faint pink blush, sweet smile\n【Action Pose】Cute pose, body slightly turned right, head tilted left, hands clasped near chest, slender soft fingers\n【Environment Scene】Pink-to-white gradient background, dreamy atmosphere, floating cherry blossom petals\n【Composition Style】Half-body shot, slightly from above, soft diagonal composition\n【Style Features】Masterpiece, best quality, ultra-detailed, anime style, cel shading, clean line art\n【Lighting Effects】Soft light from upper left, gentle rim light around hair, catchlights in eyes\n【Color Palette】White, red, gold palette, soft pastel tones, pink-purple gradient hair\n【Details Texture】Sailor uniform with gold trim, red bow tie, pleated skirt, delicate hair strands, subtle blush\n【Quality Parameters】High quality, perfect anime anatomy, detailed eyelashes, vivid colors\n【Clothing Styling】White sailor top, navy collar, red bow, red-white pleated skirt, white knee-high socks, black shoes"
        }
    ]
}
...
ANIMA_EN = {
    ...
    "input_template_natural": "Here is the 2D content Prompt to optimize:\n#\n\n**IMPORTANT: Must use pure 2D anime/manga style descriptions, strictly avoid realistic photography style terms.**\nDescribe character appearance, art style, facial features, lighting and atmosphere, clothing details, composition and perspective, background and scene.",
    "input_template_structured": "Here is the 2D content Prompt to optimize:\n#\n\n**IMPORTANT: Must use pure 2D anime/manga style descriptions, strictly avoid realistic photography style terms.**\nDescribe character appearance, art style, facial features, lighting and atmosphere, clothing details, composition and perspective, background and scene.",
    "output_format_suffix": {
        "natural": "\n\n**【Format Requirements】** Output natural paragraph text directly, describing character description, art style, facial features, lighting and atmosphere, clothing details, composition and perspective, background and scene in detail, organizing all elements into a coherent English paragraph. Do not output any explanation or other content.",
        "structured": "\n\n**【Format Requirements】** Include the following fields: 【Character Description】【Art Style】【Facial Features】【Lighting and Atmosphere】【Clothing Details】【Composition and Perspective】【Background and Scene】. Each field on one line, highly detailed, emphasizing 2D anime style features. Do not add any explanation."
    },
    "task_requirements": [
...
ZIMAGE_TURBO_EN = {
    ...
    "input_template_natural": "Below is the portrait Prompt to be optimized:\n#\n\nPlease optimize into detailed portrait photography descriptions, including subject features, action pose, environment scene, composition style, style features, lighting effects, color palette, details texture, technical parameters and clothing description.",
    "input_template_structured": "Below is the portrait Prompt to be optimized:\n#\n\nPlease optimize into detailed portrait photography descriptions, including subject features, action pose, environment scene, composition style, style features, lighting effects, color palette, details texture, technical parameters and clothing description.",
    "output_format_suffix": {
        "natural": "\n\n**【Format Requirements】** Output natural paragraph text directly, describing subject features, pose expression, environment scene, composition style, photography style, lighting effects, color palette, details texture, technical parameters and clothing description in detail, organizing all elements into a coherent English paragraph. Do not output any explanation or other content.",
        "structured": "\n\n**【Format Requirements】** Include the following fields: 【Subject Description】【Action Pose】【Environment Scene】【Composition Style】【Style Features】【Lighting Effects】【Color Palette】【Details Texture】【Technical Parameters】【Clothing Styling】. Each field on one line, highly detailed, emphasizing portrait photography details. Do not add any explanation."
    },
    "task_requirements": [
        ...
        "Composition style: Explain composition (full body, half body, close-up), lens focal length, perspective, depth of field",
        "Style features: Define photography style or genre (Japanese fresh, Korean refined, European/American fashion, classical painterly, French慵懒等)",
...
FLUX2_KLEIN_EN = {
    ...
    "input_template_natural": "Below is the Prompt to be optimized:\n#\n\nPlease optimize into detailed image descriptions, including subject features (if any), action pose (if any), environment scene, composition style, style features, lighting effects, color palette, details texture, technical parameters, and clothing description (if applicable).",
    ...
    "output_format_suffix": {
        ...
        "structured": "\n\n**【Format Requirements】** Fields dynamically selected based on content. May include: 【Subject Description】【Action Pose】【Environment Scene】【Composition Style】【Style Features】【Lighting Effects】【Color Palette】【Details Texture】【Technical Parameters】【Clothing Styling】. Each field on one line, highly detailed, emphasizing micro-details and professional photography terms. Do not add any explanation."
    },
    "task_requirements": [
        ...
        "Composition optimization: use rule of thirds, leading lines, framing descriptions",
...
QWEN_IMAGE_2512_EN = {
    ...
    "output_format_suffix": {
        ...
        "structured": "\n\n**【Format Requirements】** Include the following fields: 【Design Type】【Composition Description】【Subject Elements】【Color Scheme】【Typography Style】【Detail Elements】【High-Resolution Features】. Each field on one line, highly detailed, emphasizing high-resolution 2512x2512 details. Do not add any explanation."
    },
    "task_requirements": [
...
WAN_T2V_EN = {
    ...
    "input_template_natural": "Below is the Prompt to be optimized:\n#\n\nWithout changing the original intent (such as subject, action), add appropriate cinematic aesthetic settings to optimize into high-quality video generation prompts.",
    "input_template_structured": "Below is the Prompt to be optimized:\n#\n\nWithout changing the original intent (such as subject, action), add appropriate cinematic aesthetic settings to optimize into high-quality video generation prompts.",
    "output_format_suffix": {
        "natural": "\n\n**【Format Requirements】** Output natural paragraph text directly, incorporating appropriate cinematic elements such as camera, lighting, and color tone, organizing all content into a coherent English paragraph. Output as pure text only, do not output any explanation or other content.",
        "structured": "\n\n**【Format Requirements】** Include the following fields: 【Time Setting】【Lighting Effects】【Shot Composition】【Color Atmosphere】【Camera Movement】【Technical Parameters】. Each field on one line, highly detailed, providing richer cinematic elements and professional parameter descriptions. Do not add any explanation."
    },
    "task_requirements": [
    ...
    "constraints": {
        "max_length": 500,
        "content_type": "Strictly describe cinematic aesthetic elements, including time setting, lighting effects, shot composition, color atmosphere, camera movement and technical parameters",
        "focus": "Add cinematic elements without changing original intent, enhancing visual quality and narrative"
    },
    "cinematic_options": {
...
WAN_FLF2V_EN = {
    ...
    "task_requirements": [
        ...
        "Carefully analyze and identify **all specific visual differences** between first frame and last frame (such as: object position movement, character posture change, lighting intensity change, new or disappearing elements)",
...
VIDEO_TO_PROMPT_EN = {
    ...
    "examples": [
        "Japanese Zen garden scene|No subject|Static scene, rake marks on gravel visible, koi swimming in pond|Camera slowly pushing in, orbiting garden|Calm Zen atmosphere, soft morning light, green and gold color tones",
...
VIDEO_SUBTITLE_FORMAT_EN = {
    ...
    "input_template_structured": "Strictly follow standard subtitle format (timecode + synchronized text) for optimization. If custom content is provided, use it as the basis: #\n\n**Output subtitle text directly** using the following segmented format:\n**Timecode:** 00:00:00,000 --> 00:00:05,000\n**Subtitle Text:** ...\n\nEach subtitle separated by line breaks. Do not use JSON format.",
    "output_format_suffix": {
    ...
    "task_requirements": [
        ...
        "Subtitles concise and smooth, adapting to colloquial or scene narration rhythm",
        "Ensure timecode and text are synchronized",
        "Output text format directly, no JSON"
    ],
    "constraints": {
        "max_length": 500,
        "content_type": "Strictly follow standard subtitle format, including timecode (00:00:00,000 --> 00:00:05,000) and subtitle text",
        "focus": "Ensure timecode and text synchronization, subtitles concise and smooth, fitting frame rhythm"
    },
    "examples": [
...
MULTI_SPEAKER_DIALOGUE_EN = {
    ...
    "input_template_structured": "Create dialogue text containing multiple speakers and assign appropriate voice timbres to each speaker, facilitating TTS (Text-to-Speech) model to generate mixed-timbre audio. If custom content is provided, use it as the basis: #\n\n**Output dialogue text directly** using the following format:\n**Voice:** Female/Male/Loli/Boy/Mature/Middle-aged\n**Speaker ID:** 0-5\n**Emotion:** Happy/Sad/Angry/Calm/Excited/Gentle\n**Dialogue:** Speaker: ...\n\nEach dialogue separated by line breaks. Do not use JSON format.",
    "output_format_suffix": {
    ...
    "constraints": {
        "max_length": 500,
        "content_type": "Strictly create dialogue text with multiple speakers, including voice type, speaker_id, emotion label and dialogue content",
...
LYRICS_CREATION_EN = {
    ...
    "input_template_structured": "Create professional English lyrics. If custom content is provided, use it as the basis: #\n\n**Output lyrics directly** in the following format:\n**Structure:** [Verse 1]/[Chorus]/[Bridge]/[Outro]\n**Lyrics:** ...\n**Theme:** ...\n**Style:** ...\n**Mood:** ...\n\nEach section separated by line breaks. Do not use JSON format.",
    "output_format_suffix": {
    ...
    "constraints": {
        "max_length": 600,
        "content_type": "Strictly create professional English lyrics with complete song structure (Verse, Chorus, Bridge, Outro)",
