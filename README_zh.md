...
### 工作流文件
- [文本或图像模式工作流](./workflows/llama-cpp-vlmforQo(textorimage).json)
- [视频模式工作流](./workflows/llama-cpp-vlmforQo(video).json)

### 工作流示例图片

#### 文本生成
![工作流示例 - 文本生成](./workflows/TextGeneration.png)

#### 图像处理
![工作流示例 - 批量图像处理](./workflows/BatchlmageProcessing.png)

![工作流示例 - 图像反推](./workflows/Imagereverseengineering.png)

#### 视频处理
![工作流示例 - 视频文本生成](./workflows/VideoTextGeneration.png)

![工作流示例 - 视频帧模式](./workflows/Videoframemode.png)

![工作流示例 - 视频反推](./workflows/Videoreverseengineering.png)

#### 多图像视频文本生成
![工作流示例 - 多图像视频文本生成](./workflows/Multi-lmageVideoTextGeneration.png)
